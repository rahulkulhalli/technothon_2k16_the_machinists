    ...
    private class sendHttpRequestToAws extends AsyncTask<File, Void, File>{
        ...
        protected File doInBackground(File... files) {
            ...
            try {
                ...
                //update something based on response
...
/*                try {
                ...
                /*
                *
                * The method below starts an AsyncTask. Pass the audio file path below
                *
                * */
    ...
    public String postFile(File file) throws Exception {
        ...
        HttpPost post = new HttpPost("<POST URL here>");
            ...
            public void writeTo(OutputStream outstream) throws IOException {
                ...
                class ProgressiveOutputStream extends ProxyOutputStream {
                    ...
                    public void write(byte[] bts, int st, int end) throws IOException {
                        ...
                        //SOUMYAKANT -> PLEASE UPDATE THE PROGRESSBAR. I HAVEN'T WORKED WITH IT BEFORE
